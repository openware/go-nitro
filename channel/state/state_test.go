...
var correctSignature = Signature{
	R: common.Hex2Bytes(`b3b69fbfbdcb3100d6e5758c5661d0d793bc227716d16fd6235ccd588cae2849`),
	S: common.Hex2Bytes(`500969f691a848245910e9ac7688bbc28198b6a6e723299751bda6234bff77f3`),
	V: byte(1),
}
